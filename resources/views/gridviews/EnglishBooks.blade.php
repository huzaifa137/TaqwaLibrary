    ...
    <div class="col-md-9 col-md-push-3">
        ...
        <div class="books-gird">
            <ul>
                <li>
                    <figure>
                        <img src="/assets/images/books-media/gird-view/book-media-grid-01.jpg" alt="Book">
                        <figcaption>
                    ...
                    <div class="single-book-box">
                        <div class="post-detail">
                            ...
                            <footer class="entry-footer">
                                <a class="btn btn-primary" href="{{route('BookDetails')}}">Read More</a>                 </footer>
                        </div>
                    </div>                                       
                </li>
                <li>
                    <figure>                                                    
                        <img src="/assets/images/books-media/gird-view/book-media-grid-02.jpg" alt="Book">
                        <figcaption>
                            <p><strong>The Great Gatsby</strong></p>
                            <p><strong>Author:</strong>  F. Scott Fitzgerald</p>
                        </figcaption>
                    ...
                    <div class="single-book-box">
                        <div class="post-detail">
                            ...
                            <footer class="entry-footer">
                                <a class="btn btn-primary" href="{{route('BookDetails')}}">Read More</a>
                            </footer>
                        </div>
                    </div>                                                                                                
                </li>
                <li>
                    <figure>
                        <img src="/assets/images/books-media/gird-view/book-media-grid-03.jpg" alt="Book">
                        <figcaption>
                            <p><strong>The Great Gatsby</strong></p>
                            <p><strong>Author:</strong>  F. Scott Fitzgerald</p>
                        </figcaption>
                ...
                <li>
                    <figure>
                        <img src="/assets/images/books-media/gird-view/book-media-grid-04.jpg" alt="Book">
                        <figcaption>
                            <p><strong>The Great Gatsby</strong></p>
                            <p><strong>Author:</strong>  F. Scott Fitzgerald</p>
                        </figcaption>
                ...
                <li>
                    <figure>
                        <img src="/assets/images/books-media/gird-view/book-media-grid-05.jpg" alt="Book">
                        <figcaption>
                            <p><strong>The Great Gatsby</strong></p>
                            <p><strong>Author:</strong>  F. Scott Fitzgerald</p>
                        </figcaption>
                ...
                <li>
                    <figure>
                        <img src="/assets/images/books-media/gird-view/book-media-grid-06.jpg" alt="Book">
                        <figcaption>
                            <p><strong>The Great Gatsby</strong></p>
                            <p><strong>Author:</strong>  F. Scott Fitzgerald</p>
                        </figcaption>
                ...
                <li>
                    <figure>
                        <img src="/assets/images/books-media/gird-view/book-media-grid-07.jpg" alt="Book">
                        <figcaption>
                            <p><strong>The Great Gatsby</strong></p>
                            <p><strong>Author:</strong>  F. Scott Fitzgerald</p>
                        </figcaption>
                ...
                <li>
                    <figure>
                        <img src="/assets/images/books-media/gird-view/book-media-grid-08.jpg" alt="Book">
                        <figcaption>
                            <p><strong>The Great Gatsby</strong></p>
                            <p><strong>Author:</strong>  F. Scott Fitzgerald</p>
                        </figcaption>
                ...
                <li>
                    <figure>
                        <img src="/assets/images/books-media/gird-view/book-media-grid-09.jpg" alt="Book">
                        <figcaption>
                            <p><strong>The Great Gatsby</strong></p>
                            <p><strong>Author:</strong>  F. Scott Fitzgerald</p>
                        </figcaption>
                ...
                <li>
                    <figure>
                        <img src="/assets/images/books-media/gird-view/book-media-grid-10.jpg" alt="Book">
                        <figcaption>
                            <p><strong>The Great Gatsby</strong></p>
                            <p><strong>Author:</strong>  F. Scott Fitzgerald</p>
                        </figcaption>
                ...
                <li>
                    <figure>
                        <img src="/assets/images/books-media/gird-view/book-media-grid-11.jpg" alt="Book">
                        <figcaption>
                            <p><strong>The Great Gatsby</strong></p>
                            <p><strong>Author:</strong>  F. Scott Fitzgerald</p>
                        </figcaption>
                ...
                <li>
                    <figure>
                        <img src="/assets/images/books-media/gird-view/book-media-grid-12.jpg" alt="Book">
                        <figcaption>
                            <p><strong>The Great Gatsby</strong></p>
                            <p><strong>Author:</strong>  F. Scott Fitzgerald</p>
                        </figcaption>
