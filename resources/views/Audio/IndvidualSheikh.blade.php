    ...
    <main>
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container">
                ...
                <form action="#" method="post" enctype="multipart/form-data" class="custom-form search-form flex-fill me-3" role="search">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-lg-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarLightDropdownMenuLink" role="button"
                                data-bs-toggle="dropdown" aria-expanded="false">DUA & ADHKAR</a>

                            <ul class="dropdown-menu dropdown-menu-light" aria-labelledby="navbarLightDropdownMenuLink">
                                <li><a  class="dropdown-item" href="{{route('morning-adhkar')}}">Morning Adhkar</a></li>
                                <li><a class="dropdown-item" href="{{route('evening-adhkar')}}">Evening Adhkar</a></li>
                                <li><a  class="dropdown-item" href="{{route('Adhkar-After-Swalah')}}">Adhkar after swalah</a></li>
                                <li><a class="dropdown-item" href="{{route('Famous-Duas-from-the-Quran')}}">Famous-Duas-from-the-Quran</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-12">
                        <div class="text-center mb-5 pb-2">
                            <h1 class="text-white">Listen to Sheikh {{$SheikhAudio->sheikh_name}} Islamic Lectures</h1>
                        </div>
                        ...
                        <div class="custom-block custom-block-full">
                            <div class="custom-block-image-wrap">
                                <a href="javascript:void();">
                                    <img src="/audio_assets/images/podcast/27376480_7326766.jpg" class="custom-block-image img-fluid"
                                        alt="">
                                </a>
                            </div>
                            ...
                            <div class="custom-block-info">
                                ...
                                <p class="mt-1" style="color:#000;"><strong>Topic : {{$SheikhAudio->topic}}</strong></p>

                                <div class="custom-block-bottom d-flex justify-content-between mt-1">
                                    <a href="{{url('/download-Audio',$SheikhAudio->audio)}}" class="bi-download me-1">
        ...
        <div class="container pt-5">
            <div class="row align-items-center">
                ...
                <div class="col-lg-3 col-12">
                    <p class="copyright-text mb-0">Copyright © 2023 Taqwa Library</p> 
                </div>
            </div>
        </div>
    </footer>
